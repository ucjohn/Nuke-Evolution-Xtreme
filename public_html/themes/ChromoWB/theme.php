...
$pms = $db->sql_numrows($db->sql_query("SELECT privmsgs_to_userid FROM ".$prefix."_bbprivmsgs WHERE privmsgs_to_userid='$uid' AND (privmsgs_type='5' OR privmsgs_type='1')"));
    ...
    if ($username == "Anonymous") {
        $theuser = "<table style='width: 100%; border: 0;' cellpadding='0' cellspacing='0'>
                      <tr>
...
echo "<div align='center'><font color=\"#e2e2e2\" class=\"ftrt\"><strong>PHP-Nuke Copyright &copy; 2006 By: Francisco Burzi.<br>
ChromoWB Color Version By: The Mortal @ <a href=\"http://www.realmdesignz.com\" target=\"_blank\">Realm Designz</a><br><a href=\"http://www.evolution-xtreme.com\" title=\"Xtreme 2.0 Edition\">Xtreme 2.0 Edition</a></strong></font></div></td>\n";
echo "		<td>\n";
